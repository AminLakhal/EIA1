...
window.addEventListener("load", () => {
    ...
    for (let i = 0; i < 3; i++) { document.getElementsByClassName("button")[i].addEventListener("click", (addDifficulty)); }
...
var countryStartCounter: number = 0;
var countryEndCounter: number = 0;
let difficulty;
if (counter == 0) {
    document.querySelector<HTMLElement>(".minusS").style.opacity = "0";
}

if (counter2 == 0) {
    document.querySelector<HTMLElement>(".minusE").style.opacity = "0";
}

function countryButtonHandlerTopRight(): void {
    if (counter < countries.length) {

        if (counter < countries.length && counter >= 0) { document.querySelector<HTMLElement>(".minusS").style.opacity = "1"; }
        counter++;
        ...
        console.log(counter); countryStartCounter = countries.indexOf(countries[counter]);
        playSample(0);
        if (counter == countries.length - 1) {
            document.querySelector<HTMLElement>(".minusS").style.opacity = "1";
            document.querySelector<HTMLElement>(".plusS").style.opacity = "0";
            document.querySelector(".minusS").addEventListener("click", (countryButtonHandlerTopLeft));
...
function countryButtonHandlerTopLeft(): void {
    if (counter < countries.length) {

        if (counter < countries.length && counter >= 0) { document.querySelector<HTMLElement>(".plusS").style.opacity = "1"; }
        counter--;
        ...
        if (counter == 0) {
            document.querySelector<HTMLElement>(".minusS").style.opacity = "0";
            document.querySelector<HTMLElement>(".plusS").style.opacity = "1";
            document.querySelector(".plusS").addEventListener("click", (countryButtonHandlerTopRight));
...
function countryButtonHandlerBottomRight(): void {
    if (counter2 < countries.length) {

        if (counter2 < countries.length && counter2 >= 0) { document.querySelector<HTMLElement>(".minusE").style.opacity = "1"; }
        counter2++;
        ...
        console.log(counter2); countryEndCounter = countries.indexOf(countries[counter2]);
        playSample(0);
        if (counter2 == countries.length - 1) {
            document.querySelector<HTMLElement>(".minusE").style.opacity = "1";
            document.querySelector<HTMLElement>(".plusE").style.opacity = "0";
            document.querySelector(".minusE").addEventListener("click", (countryButtonHandlerBottomLeft));
...
function countryButtonHandlerBottomLeft(): void {
    if (counter2 < countries.length) {

        if (counter2 < countries.length && counter2 >= 0) { document.querySelector<HTMLElement>(".plusE").style.opacity = "1"; }
        counter2--;
        ...
        if (counter2 == 0) {
            document.querySelector<HTMLElement>(".minusE").style.opacity = "0";
            document.querySelector<HTMLElement>(".plusE").style.opacity = "1";
            document.querySelector(".plusE").addEventListener("click", (countryButtonHandlerBottomRight));
...
function startButtonHandler() {
    ...
    if (difficulty === undefined) { alert("select difficulty first"); } else {
