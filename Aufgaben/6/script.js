...
let iNutzer08 = [504000, 304000, 20420000, 39130000,];
for (let i = 0; i < arr.length; i++) {
    console.log("Die Internetnutzung in", arr[i].name, "beträgt im Jahr 2020:", arr[i].iNutzer20 * 100 / arr[i].eZahl20, "%.", "Relativ zur Gesamtzahl der Internetnutzer in der EU beträgt die Internetnutzung prozentual in", arr[i].name, arr[i].iNutzer20 * 100 / euiNutzerzahl2020, "% im Jahr 2020:", "Für ", arr[i].name, "hat sich die Internetnutzung im Jahr 2020 im Vergleich zu 2008 um ", iNutzer08[i] * 100 / arr[i].iNutzer20, "% verändert.");
}
