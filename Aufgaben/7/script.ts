...
let iNutzer08: number[] = [5040000, 3040000, 20420000, 39130000,]
let gNutzer22: number = arr[0].iNutzer22 + arr[1].iNutzer22 + arr[2].iNutzer22 + arr[3].iNutzer22;
let gNutzer08: number = iNutzer08[0] + iNutzer08[1] + iNutzer08[2] + iNutzer08[3]; //gesamtnutzer08
let gEinw22: number = arr[0].eZahl22 + arr[1].eZahl22 + arr[2].eZahl22 + arr[3].eZahl22; //gesamtnutzer
